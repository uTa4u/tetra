...
public class GuiStats {
    ...
    public static final IStatGetter quickslotGetter = new StatGetterEffectLevel(ItemEffect.QUICK_SLOT, 1d);
    ...
    public static final IStatGetter potionStorageGetter = new StatGetterEffectLevel(ItemEffect.POTION_SLOT, 1d);
    ...
    public static final IStatGetter storageGetter = new StatGetterEffectLevel(ItemEffect.STORAGE_SLOT, 1d);
    ...
    public static final IStatGetter quiverGetter = new StatGetterEffectLevel(ItemEffect.QUIVER_SLOT, 1d);
    ...
    public static final IStatGetter armorPenetrationGetter = new StatGetterEffectLevel(ItemEffect.ARMOR_PENETRATION, 1);
    ...
    public static final IStatGetter unarmoredDamageGetter = new StatGetterEffectLevel(ItemEffect.UNARMORED_DAMAGE, 1);
    ...
    public static final IStatGetter silkTouchGetter = new StatGetterEffectLevel(ItemEffect.SILK_TOUCH, 1);
    ...
    public static final IStatGetter quickStrikeGetter = new StatGetterEffectLevel(ItemEffect.QUICK_STRIKE, 5, 20);
    ...
    public static final IStatGetter softStrikeGetter = new StatGetterEffectLevel(ItemEffect.SOFT_STRIKE, 1);
    ...
    public static final IStatGetter fierySelfGetter = new StatGetterEffectEfficiency(ItemEffect.FIERY_SELF, 100);
    ...
    public static final IStatGetter enderReverbGetter = new StatGetterEffectEfficiency(ItemEffect.ENDER_REVERB, 100);
    ...
    public static final IStatGetter criticalGetter = new StatGetterEffectLevel(ItemEffect.CRITICAL_STRIKE, 1);
